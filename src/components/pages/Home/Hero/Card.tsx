...
const Card = ({ icon, title, desc }: ICardProp) => {
  return (
    <div className="border-theme-night-300 bg-theme-night-100 flex h-60 w-60 flex-shrink-0 flex-col items-center justify-center gap-1 overflow-auto rounded-2xl border p-8">
      {icon}
